...
export function AdminControlPage() {
    ...
    const ACTION_COLORS: Record<string, string> = {
        ...
        ASSESSMENT_FOLLOWUP_SAVED: 'bg-yellow-100 text-yellow-700',
        ASSESSMENT_FOLLOWUP_UPDATED: 'bg-yellow-200 text-yellow-800',
        ASSESSMENT_DELETED: 'bg-red-100 text-red-700',
        ASSESSMENT_DATA_EXPORTED: 'bg-teal-100 text-teal-700',
        SERVICE_ENTRY_DELETED: 'bg-red-100 text-red-700',
        SERVICE_HISTORY_EXPORTED: 'bg-teal-100 text-teal-700',
        BENEFICIARY_DATA_EXPORTED: 'bg-teal-100 text-teal-700',
        BENEFICIARY_BULK_IMPORTED: 'bg-blue-200 text-blue-800',
